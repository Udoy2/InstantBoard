...
Button buttons[] = {
    ...
    {10, 120, 100, 25, "CIRCLE (C)", setCircleTool}, // New Circle Tool button
    {10, 160, 100, 25, "UNDO (U)", undoLastStroke},
    {10, 200, 100, 25, "CLEAR", clearScreen},
    {30, 240, 30, 25, "+", increasePointSize},
    {70, 240, 30, 25, "-", decreasePointSize}
};
...
void keyboard(unsigned char key, int x, int y) {
    switch (tolower(key)) {
        ...
        case 'e':
            ...
            glutPostRedisplay();
            break;
        case 'c': // Add shortcut for Circle Tool
            setCircleTool();
            glutPostRedisplay();
            break;
        case 'u':
